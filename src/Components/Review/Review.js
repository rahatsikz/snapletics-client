...
const Review = ({ rev }) => {
  ...
  return (
    <div>
      <div className="overflow-hidden text-center bg-white rounded shadow-2xl text-slate-500 shadow-slate-200 my-8">
        <div className="relative p-6">
          <figure className="relative z-10">
            <blockquote className="p-6 text-lg leading-relaxed">
              <p>{review}</p>
            </blockquote>
            <figcaption className="flex flex-col items-center gap-2 p-6 pt-0 text-sm text-emerald-500">
              <div>
                {ratings === "5" ? (
              ...
              <div className="flex flex-col items-center gap-4 pt-4 text-sm text-left text-emerald-500">
                <img
                  src={photo}
                  alt="user name"
                  title={reviewer}
                ...
                <div className="flex flex-col gap-1">
                  <span className="font-bold uppercase"> {reviewer} </span>
                </div>
              </div>
            </figcaption>
          </figure>
